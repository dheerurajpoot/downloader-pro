          ...
          <Card className="border-green-200 shadow-md overflow-hidden">
            ...
            <CardContent className="p-6">
              ...
              <form className="space-y-4">
                ...
                <div className="space-y-2">
                  <label htmlFor="subject" className="text-sm font-medium text-green-700">
                    Subject
                  </label>
                  <Input
                    id="subject"
                ...
                <Button className="w-full green-gradient hover:opacity-90 transition-opacity">Send Message</Button>
              </form>
            </CardContent>
          </Card>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-green-700">support@socialmediadownloader.com</p>
                    </div>
                  </div>
