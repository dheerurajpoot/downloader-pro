...
import { Download, Loader2, LinkIcon, AlertCircle, ExternalLink } from "lucide-react"
              ...
              <div className="p-4 space-y-4">
                {result.success ? (
                  <>
                    {result.thumbnail && (
                      <div className="flex justify-center">
                        <img
                          src={result.thumbnail || "/placeholder.svg?height=300&width=500"}
                    ...
                    <h3 className="text-lg font-medium text-green-800">{result.title || "Your content is ready!"}</h3>
                      ...
                      >
                        {downloadStarted ? (
                          ...
                          <>
                            ...
                            {result.isExternal ? "Open Video" : `Download ${result.type || "Content"}`}
                          </>
                        )}
                      </Button>
                    </div>
                    ...
                    {result.isExternal && (
                      <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-md text-sm text-yellow-800">
                        <p>
                          <strong>Note:</strong> For YouTube videos, we'll open the video in a new tab. You can use
                          browser extensions or online services to download the video.
                        </p>
                      </div>
                    )}
                  </>
                  ...
                  <div className="flex items-center p-4 text-red-800 bg-red-50 rounded-lg">
                    ...
                    <p>{result.message || "An error occurred. Please try again."}</p>
                  </div>
                )}
              </div>
            </div>
